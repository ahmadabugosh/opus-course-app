...
export const LESSONS: LessonMeta[] = [
  ...
  {
    id: 2,
    title: 'Using Opus Templates',
    description: 'Leverage pre-built workflows to save time and 10x your productivity.',
    duration: '20 minutes',
    videoUrl: '/videos/lesson-02.mp4',
    challenge: {
      title: 'Activate a Template Workflow',
      description: 'Find, customize, and activate a template workflow for a process you currently run or want to automate.',
      verificationType: 'url',
      verificationPrompt: 'Paste your activated workflow URL or a screenshot showing the workflow with all action items resolved.',
      verificationMinLength: 30,
      hint: 'Make sure all action items are fixed and the workflow is activated before submitting.',
    },
